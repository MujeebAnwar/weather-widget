...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
                ...
                <div class="col-md-8 col-lg-6 col-xl-4 ">
                    ...
                    <div id="main-content" class="d-none">
                        ...
                        <div class="input-group rounded mb-3">
                            <input type="search" id="pac-input" class="form-control rounded" placeholder="Enter Your Location" aria-label="Search"
                                   aria-describedby="search-addon" />
                        </div>
                        <div class="card shadow-0 border">
                            <div class="card-body p-4">

                                <h4 class="mb-1 sfw-normal" id="country-title"></h4>
    ...
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAItWlkhk_29WuGZ5udToIdprKNm77t7JQ&callback=initMap&libraries=places&v=weekly&channel=2
" async></script>
    <script>
            ...
            $.ajax({
                ...
                success:function (response) {
                    if(response.status)
                    {
                        ...
                        $('#feels-like').empty().html(feels_like+' °C')
                        $('#current-temp').empty().html(current_temp+' °C')
                        $('#min-temp').empty().html(min_temp+' °C')
                        $('#max-temp').empty().html(max_temp+' °C')
                        $('#wi-con').attr('src','http://openweathermap.org/img/w/'+icon+'.png')
